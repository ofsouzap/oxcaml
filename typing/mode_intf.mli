  ...
  include
    Common
      with module Const := Const
       and type error = (Const.t, hint_morph, hint_const) serror
end
...
module type Common_product = sig
  ...
  type error = Error : 'a axis * ('a, 'morph, 'const) serror -> error
...
module type S = sig
  ...
  module type Mode := sig
    ...
    type error =
      | Error : ('a, _, _) Axis.t * ('a, 'morph, 'const) serror -> error
  ...
  module Modality : sig
    ...
    module Value : sig
      ...
      type error =
        | Error :
            ('a, _, _) Value.Axis.t * ('a raw, 'morph, 'const) serror
            -> error
